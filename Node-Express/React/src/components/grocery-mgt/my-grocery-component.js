...
export default function MyGrocery() {
  ...
  let displayFruitGroceryCollection = groceryCollection.map(
    ({ name, cat, selected }, index) => {
      return (
        <span key={index}>
          {cat == "Fruit" && (
            <span>
  ...
  let displayVegitablesGroceryCollection = groceryCollection.map(
    ({ name, cat, selected }, index) => {
      return (
        <span key={index}>
          {cat == "Vegitables" && (
  ...
  let displayOthersGroceryCollection = groceryCollection.map(
    ({ name, cat, selected }, index) => {
      return (
        <span key={index}>
          {cat == "Others" && (
  ...
  let displayFrozenGroceryCollection = groceryCollection.map(
    ({ name, cat, selected }, index) => {
      return (
        <span key={index}>
          {cat == "Frozen" && (
  ...
  let displayBakeryGroceryCollection = groceryCollection.map(
    ({ name, cat, selected }, index) => {
      return (
        <span key={index}>
          {cat == "Bakery" && (
  ...
  return (
    <div className="row">
        ...
        <div className="groceryListHeaderDetails">
          <div className="row">
            ...
            <div className="col-sm-5 verticalCenter">
              <button className="btn btn-block " onClick={addNewItem}>
      ...
      <div className="groceryListContainer">
        <div className="row">
          <div className="col-sm-3">
            <button className="btn btn-block " onClick={saveMyList}>
          ...
          <div className="col-sm-9">
            <ul>
              <li>Do Check To Add Item To Your Grocery List</li>
              <li>
                Undo Check To Remove Item (Or) Bought Item From Your Grocery
                List
              </li>
            </ul>
          </div>
        ...
        <div className="row">
          <div className="col-sm-4">
            ...
            <ul className="grocery-list">{displayFruitGroceryCollection}</ul>
            <h3>
              <u>Frozen</u>
            </h3>
            <ul className="grocery-list">{displayFrozenGroceryCollection}</ul>
          </div>
          ...
          <div className="col-sm-4">
            ...
            <ul className="grocery-list">{displayBakeryGroceryCollection}</ul>
          </div>
          ...
          <div className="col-sm-4">
            ...
            <ul className="grocery-list">{displayOthersGroceryCollection}</ul>
          </div>
        </div>
      </div>
    </div>
