        ...
        return (
            <div className="container">
                <div className="homePageHeader">
                    ...
                    <h5>Technology : Node JS / Express / JSON File Storage / React JS</h5>
                </div>
                <hr />
                <p></p>
                <div className="row">
                            ...
                            <ListGroup>
                                ...
                                <div>
                                    <ul className="homeMathTest">
                                        ...
                                        <li>
                                            User should Login with valid UserName and Password to access <u><b>Math-Test and My-Events Module </b></u>
                                        </li>
                                        <li>
                                            After successfully completion of any Math-Test, User's Parent will receive Test's Result by Email
                                        </li>
                                    </ul>                                 
                                </div>
                            </ListGroup>
                            ...
                            <ListGroup>
                                ...
                                <div>
                                    <ul>
                                        ...
                                        <li>User can View Events for Today, Current Week or Current Month</li>
                                    </ul>
                                </div>
                            </ListGroup>
                        </div>                                                                                 
