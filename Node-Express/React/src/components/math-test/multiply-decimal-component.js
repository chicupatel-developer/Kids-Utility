...
export default class MultiplyDecimal extends Component {
    constructor(props) {
        super(props);
    ...
    getWrongAnswer1 = () => {
        var number1 = this.state.number1;
        var number2 = this.state.number2;
        var wrongAnswer1 = ((number1 * number2).toFixed(2) * 0.1).toFixed(3);
        this.setState({
    ...
    getWrongAnswer2 = () => {
        var number1 = this.state.number1;
        var number2 = this.state.number2;
        var wrongAnswer2 = ((number1 * number2).toFixed(2) * 10).toFixed(1);
        this.setState({
                                ...
                                <div className="col-sm-10" >
                                    <div>
                                        <DisplayQuestion
                                            ...
                                            wrongAnswer1={((number1 * number2).toFixed(2) * 0.1).toFixed(3).toString()}
                                            wrongAnswer2={((number1 * number2).toFixed(2) * 10).toFixed(1).toString()}
                                        />
                                    </div>
                                </div >
                        )}
