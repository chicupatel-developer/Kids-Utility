...
const number1Upper = 9;
const number2Lower = 10;
const number2Upper = 99;


export default class Minus1By2 extends Component {
    constructor(props) {
        super(props);
        ...
        this.state = {
            ...
            testName: 'Minus [1 Digit - 2 Digits]',
    ...
    getCorrectAnswer = () => {
        var correctAnswer = this.state.number1 - this.state.number2;
        this.setState({
                                ...
                                <div className="col-sm-10" >
                                    <div>
                                        <DisplayQuestion
                                            ...
                                            wrongAnswer1={(-1 * (number1 - number2)).toString()}
                                            wrongAnswer2={(number1 - number2 - 1).toString()}
                                        />
                                    </div>
                                </div >
                        )}
