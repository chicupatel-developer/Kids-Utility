...
const number1Lower = 0;
const number1Upper = 99;
const number2Lower = 1;
const number2Upper = 9;


export default class Division2By1 extends Component {
    constructor(props) {
        super(props);
    ...
    getStart() {
        ...
        this.getNumber1(number1Lower, number1Upper);
        this.getNumber2(number2Lower, number2Upper);
    ...
    getCorrectAnswer = () => {
        ...
        var correctAnswer = parseFloat((Math.round(this.state.number1 / this.state.number2 * 10) / 10).toFixed(1));
    ...
    getWrongAnswer1 = () => {
        var wrongAnswer1 = this.state.correctAnswer + 1;
        this.setState({
    ...
    getWrongAnswer2 = () => {
        var wrongAnswer2 = this.state.correctAnswer - 1;
        this.setState({
                                ...
                                <div className="col-sm-10" >
                                    <div>
                                        <DisplayQuestion
                                            ...
                                            wrongLocation2={wrongLocation2}
                                            operator={'/'}
                                            value={(parseFloat((Math.round(this.state.number1 / this.state.number2 * 10) / 10).toFixed(1))).toString()}
                                            wrongAnswer1={(parseFloat((Math.round(((this.state.number1 / this.state.number2) + 1) * 10) / 10).toFixed(1))).toString()}
                                            wrongAnswer2={(parseFloat((Math.round(((this.state.number1 / this.state.number2) - 1) * 10) / 10).toFixed(1))).toString()}
                                        />
                                    </div>
                                </div >
                        )}
