...
@Component({
  selector: 'app-minus-decimal',
  templateUrl: './minus-decimal.component.html',
  styleUrls: ['./minus-decimal.component.css']
})
export class MinusDecimalComponent implements OnInit {

  testName = 'Minus [Decimal]';
  operator = '-';
  totalQuestions = 10;
