...
@Component({
  selector: 'app-multiply-decimal',
  templateUrl: './multiply-decimal.component.html',
  styleUrls: ['./multiply-decimal.component.css']
})
export class MultiplyDecimalComponent implements OnInit {

  testName = 'Multiply [Decimal]';
  operator = '*';
  totalQuestions = 10;
  ...
  getNumber2 = () => {
    var number2 = this.genRand(1, 9, 0);
    this.number2 = number2;
    return number2;
  }
  getCorrectAnswer = () => {    
    this.correctAnswer = (this.number1 * this.number2).toFixed(2);    
    return this.correctAnswer;
  }
  getWrongAnswer1 = () => {    
    this.wrongAnswer1 = (Number(this.number1.toFixed(2)) * Number(this.number2) * Number(this.wrongVariant1.toFixed(2))).toFixed(3);
    return this.wrongAnswer1;
  }
  getWrongAnswer2 = () => {    
    this.wrongAnswer2 = (Number(this.number1.toFixed(2)) * Number(this.number2) * Number(this.wrongVariant2)).toFixed(1);
